...
// PLAN OCASIÓN $$$/Unico pago

// Perfecto para publicar un único vehículo

// -1 publicación activa en simultáneo -Posicionamiento máximo -Duración ilimitada de la publicación -Hasta 30 fotos por vehículo -Chat con compradores -Recibe ofertas directas -Estadísticas básicas de visitas -Renovación manual -Soporte vía email -Perfil de vendedor personalizado

// PLAN VENDEDOR $$$/Suscripción mensual

// Ideal para vendedores frecuentes

// -Hasta 3 publicaciones simultáneas -Duración ilimitada de publicaciones -50 fotos por vehículo -Publicaciones destacadas -Chat y ofertas -Estadísticas detalladas -Posicionamiento máximo preferencial -Soporte prioritario -Badge de Vendedor Verificado -Renovación automática opcional -Perfil de concesionaria personalizado

// PLAN AGENCIA $$$/Suscripción mensual

// Solución completa para profesionales

// -Publicaciones ilimitadas -Duración ilimitada de publicaciones -Máxima visibilidad en búsquedas -Ilimitado fotos + video por vehículo -Todas las publicaciones destacadas -Panel de administración profesional -Perfil de concesionaria personalizado -Estadísticas avanzadas y reportes -Soporte 24/7 prioritario -Badge de Vendedor Profesional -Herramientas de marketing incluidas -Acceso a datos de mercado
